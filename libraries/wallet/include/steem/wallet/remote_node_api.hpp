...
struct remote_node_api
{
   ...
   steem::plugins::sps::list_proposals_return list_proposals(fc::variant _start, steem::plugins::sps::order_by_type _order_by, int _limit, steem::plugins::sps::proposal_status _status);
   steem::plugins::sps::list_voter_proposals_return list_voter_proposals(fc::variant _start, steem::plugins::sps::order_by_type _order_by, int _limit, steem::plugins::sps::proposal_status _status);
