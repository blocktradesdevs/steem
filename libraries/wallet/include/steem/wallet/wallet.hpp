...
{
   public:
      wallet_api( const wallet_data& initial_data, const steem::protocol::chain_id_type& _steem_chain_id, fc::api< remote_node_api > rapi, fc::api< steem::plugins::sps::sps_api > _sps_api );
      virtual ~wallet_api();
