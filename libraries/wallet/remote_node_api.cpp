...
steem::plugins::sps::list_proposals_return remote_node_api::list_proposals(fc::variant _start, steem::plugins::sps::order_by_type _order_by, int _limit,  steem::plugins::sps::proposal_status _status)
{
   FC_ASSERT( false );
}

steem::plugins::sps::list_voter_proposals_return remote_node_api::list_voter_proposals(fc::variant _start, steem::plugins::sps::order_by_type _order_by, int _limit,  steem::plugins::sps::proposal_status _status)
{
   FC_ASSERT( false );
}
