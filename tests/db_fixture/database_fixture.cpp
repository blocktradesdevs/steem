...
template< typename T>
list_proposals_return t_proposal_database_fixture< T >::list_proposals(fc::variant _start, std::string _order_by, int _limit, std::string _status) 
{
...
template< typename T>
list_voter_proposals_return  t_proposal_database_fixture< T >::list_voter_proposals(fc::variant _start, std::string _order_by, int _limit, std::string _status) 
{
      auto api = appbase::app().get_plugin< steem::plugins::sps::sps_api_plugin >().api;
...
template list_proposals_return t_proposal_database_fixture< clean_database_fixture >::list_proposals(fc::variant _start, std::string _order_by, int _limit,  std::string _status);
template list_voter_proposals_return t_proposal_database_fixture< clean_database_fixture >::list_voter_proposals(fc::variant _start, std::string _order_by, int _limit,  std::string _status);
...
template list_proposals_return t_proposal_database_fixture< database_fixture >::list_proposals(fc::variant _start, std::string _order_by, int _limit,  std::string _status);
template list_voter_proposals_return t_proposal_database_fixture< database_fixture >::list_voter_proposals(fc::variant _start, std::string _order_by, int _limit, std::string _status) ;
