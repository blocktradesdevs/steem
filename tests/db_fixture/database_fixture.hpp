...
struct t_proposal_database_fixture : public T
{
   ...
   steem::plugins::sps::list_proposals_return list_proposals(fc::variant _start, std::string _order_by, int _limit, std::string _status) ;
   steem::plugins::sps::list_voter_proposals_return list_voter_proposals(fc::variant _start, std::string _order_by, int _limit, std::string _status) ;
